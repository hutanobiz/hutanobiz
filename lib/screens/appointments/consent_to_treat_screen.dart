...
class _ConsentToTreatScreenState extends State<ConsentToTreatScreen> {
  ...
  List<Widget> widgetList() {
    ...
    formWidget.add(Text(
        "I, $_name, certify that I am an adult over the age of 18 and as such, do hereby willingly agree to receive medical care by $name. I understand and agree that I will participate in my treatment plan and I may discontinue treatment and/or withdraw my consent for treatment at any time. \n\nI voluntarily consent to the rendering of healthcare including diagnostic procedures, and medical treatment by the provider and/or the provider's authorized designees. \n\nIn the event that I am injured or ill while under the care of the provider, I hereby give permission to the provider to provide first aid and take appropriate measures including contacting Emergency Medical Services (EMS) and arranging transportation to the nearest emergency medical facility. \n\nI hereby agree to pay the provider for all services rendered to me, or on my behalf, at the provider's then current rates. I understand that I am responsible for paying any balance not paid by my insurance company, including any deductible or copayment. I also understand that if I fail to provide the provider with adequate notice of cancellation, I will be responsible for paying a portion of the provider's fee. If I am unable to meet my financial obligations, I agree to notify the provider so that alternate arrangements can be made. I understand that the provider may ask me to provide additional documents at the time of treatment, and I agree to comply with such request. Lastly, I understand that patients receiving Medicare benefits may be ineligible for cash services and that the provider will notify me if Medicare restrictions apply to my service encounter.  ",
        style: TextStyle(
          color: colorBlack2,
          fontSize: fontSize14,
