...
class _BloodPressureChartState extends State<BloodPressureChart> {
  ...
  void getChartData() {
    chartFuture = api.getGraphData("Bearer ${getString(PreferenceKey.tokens)}",
        'bloodPressureDbp', DateTime.now().toString());
  }
          ...
          children: [
            Row(children: [
              ClipRRect(
                  ...
                  child: Image.asset('images/blood_pressure.png',
                      height: 50, width: 50)),
              SizedBox(width: 12),
              Expanded(
                child: Text(
      ...
      getTouchedSpotIndicator:
        ...
        return spotIndexes.map((spotIndex) {
          return TouchedSpotIndicatorData(
            FlLine(color: Colors.transparent, strokeWidth: 30),
            FlDotData(
  ...
  // AxisTitles leftTitles({GetTitleFunction getTitles}) =>  AxisTitles(sideTitles:  SideTitles(
  //       getTitles: getTitles,
  //       showTitles: true,
  //       margin: 8,
  //       interval: 1,
