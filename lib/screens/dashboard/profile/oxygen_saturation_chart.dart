...
class OxygenSaturationChart extends StatefulWidget {
  OxygenSaturationChart({Key key}) : super(key: key);

  @override
  State<OxygenSaturationChart> createState() => _OxygenSaturationChartState();
}
            ...
            Row(
              children: [
                ClipRRect(
                    ...
                    child: Image.asset('images/oxygen_saturation.png',
                        height: 50, width: 50)),
                SizedBox(width: 12),
                Expanded(
                  child: Text(
