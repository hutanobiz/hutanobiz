...
class Insurance {
  ...
  Insurance.fromJson(Map<String, dynamic> json) {
    ...
    _insuranceDocumentFront = json['insuranceDocumentFront'];
    _insuranceDocumentBack = json['insuranceDocumentBack'];
    _sId = json['_id'];
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['insuranceId'] = this._insuranceId;
    data['insuranceDocumentFront'] = this._insuranceDocumentFront;
    data['insuranceDocumentBack'] = this._insuranceDocumentBack;
    data['_id'] = this._sId;
    return data;
  }
}
...
class ProviderNetwork {
  ...
  ProviderNetwork.fromJson(Map<String, dynamic> json) {
    ...
    _doctorId = json['doctorId'].cast<String>();
    _sId = json['_id'];
  }
...
class FamilyNetwork {
  ...
  FamilyNetwork.fromJson(Map<String, dynamic> json) {
    ...
    _userPermissions = json['userPermissions'].cast<int>();
    _sId = json['_id'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['userPermissions'] = this._userPermissions;
    data['_id'] = this._sId;
    return data;
  }
}
